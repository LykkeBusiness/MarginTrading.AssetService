...
{
    public class AssetsEfRepository : IAssetsRepository
    {
        private MsSqlContextFactory<AssetDbContext> _contextFactory;

        public AssetsEfRepository(MsSqlContextFactory<AssetDbContext> contextFactory)
        {
