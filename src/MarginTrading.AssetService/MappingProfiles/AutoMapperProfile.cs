...
namespace MarginTrading.AssetService.MappingProfiles
{
    public class AutoMapperProfile : Profile
    {
        ...
        {
            CreateMap<SettingsChangedSourceType, SettingsTypeContract>();
            CreateMap<IAssetPair, AssetPairContract>();
            CreateMap<AssetPairContract, AssetPair>();
            CreateMap<IAsset, AssetContract>();
            CreateMap<AssetContract, Asset>();
            CreateMap<IMarket, MarketContract>();
            CreateMap<MarketContract, Market>();
            CreateMap<OrderExecutionRate, OrderExecutionRateContract>().ReverseMap();
            CreateMap<OvernightSwapRate, OvernightSwapRateContract>().ReverseMap();
            CreateMap<OnBehalfRate, OnBehalfRateContract>().ReverseMap();
            CreateMap<IScheduleSettings, ScheduleSettings>().ReverseMap();
            CreateMap<IScheduleSettings, ScheduleSettingsContract>().ReverseMap();
            CreateMap<IScheduleSettings, CompiledScheduleSettingsContract>();
            CreateMap<ScheduleSettingsContract, ScheduleSettings>().ReverseMap();
            CreateMap<ITradingCondition, TradingConditionContract>();
            CreateMap<ITradingCondition, TradingCondition>();
            CreateMap<TradingConditionContract, TradingCondition>();
            CreateMap<ITradingInstrument, TradingInstrumentContract>();
            CreateMap<TradingInstrumentContract, TradingInstrument>();
            CreateMap<ITradingRoute, MatchingEngineRouteContract>();
            CreateMap<MatchingEngineRouteContract, TradingRoute>();
